...
//        BrowserUtils.waitForStaleElement(pageSubTitle);
    ...
    public boolean waitTillSpinnerDisable()
    {
        FluentWait<WebDriver> fWait = new FluentWait<WebDriver>(Driver.get());
        ...
        Function<WebDriver, Boolean> func = new Function<WebDriver, Boolean>()
        {
            ...
            public Boolean apply(WebDriver webDriver) {
                System.out.println(loaderMask.getCssValue("display"));
                if(loaderMask.getCssValue("display").equalsIgnoreCase("none")){
                    return true;
                }
                return false;
            }
